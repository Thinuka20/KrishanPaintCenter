...
<div class="container content">
    <div class="row mb-3">
        <div class="col-md-6">
            <h2>Spare Parts Supplimentary Estimates</h2>
        </div>
        <div class="col-md-6 text-end">
            <a href="view_estimates_spare_sup.php" class="btn btn-primary">
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="action-buttons">
                                    <a href="view_repair_estimate_spare_sup.php?id=<?php echo $row['id']; ?>"
                                        class="btn btn-sm btn-info">
                                        <i class="fas fa-eye text-light"></i>
                                    </a>
                                    <a href="print_repair_estimate_spare_sup.php?id=<?php echo $row['id']; ?>"
                                        class="btn btn-sm btn-secondary" target="_blank">
                                        <i class="fas fa-print text-light"></i>
                                    </a>
                                    <a href="edit_estimate_spare_sup.php?id=<?php echo $row['id']; ?>"
            ...
            <div class="row mt-4">
                <div class="col-md-6">
                    <div class="card">
                        ...
                        FROM estimates_spareparts_supplimentary";
