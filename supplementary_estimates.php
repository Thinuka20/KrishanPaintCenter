...
<div class="container content">
    <div class="row mb-3">
        <div class="col-md-6">
            <h2>Supplimentary Estimates</h2>
        </div>
        <div class="col-md-6 text-end">
            <a href="view_estimates_sup.php" class="btn btn-primary">
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="action-buttons">
                                    <a href="view_repair_estimate_sup.php?id=<?php echo $row['id']; ?>"
                                        class="btn btn-sm btn-info">
                                        <i class="fas fa-eye text-light"></i>
                                    </a>
                                    <a href="print_repair_estimate_sup.php?id=<?php echo $row['id']; ?>"
                                        class="btn btn-sm btn-secondary" target="_blank">
                                        <i class="fas fa-print text-light"></i>
                                    </a>
                                    <a href="edit_estimate_sup.php?id=<?php echo $row['id']; ?>"
