...
<div class="container content">
    ...
    <div class="row mb-3">
        <div class="col-md-6">
            <h2>View Supplimentary Estimate #<?php echo $estimate['estimate_number']; ?></h2>
        </div>
...
<script>
    function printEstimate(id) {
        const query = "SELECT e.*, ei.* FROM estimates_supplimentary e JOIN estimate_items_supplimentary ei ON e.id = ei.estimate_id WHERE e.id = '" + id + "'";

        const form = document.createElement('form');
        form.method = 'POST';
        form.action = 'print_repair_estimate_sup.php';
        form.target = '_blank';
