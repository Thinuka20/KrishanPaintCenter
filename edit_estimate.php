...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    Database::iud("DELETE FROM estimate_items WHERE estimate_id = '" . $id . "'");
    ...
    header("Location: initial_estimates.php?success=Estimate updated successfully");
    exit();
}
...
$items_result = Database::search("SELECT * FROM estimate_items WHERE estimate_id = '" . $id . "'");
