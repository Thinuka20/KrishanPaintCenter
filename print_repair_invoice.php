...
<head>
    ...
    <style>
        ...
        .invoice-footer { border-top: 2px solid #dee2e6; margin-top: 10px; padding-top: 10px; }
    ...
    <div class="p-3">
                ...
                <table class="table table-bordered">
                    ...
                    <tfoot>
                        ...
                        <tr>
                            ...
                            <th><?php echo formatCurrency($invoice['total_amount'] - $total_paid); ?></th>
                        </tr>
                    </tfoot>
                </table>
            </div>
        ...
        <div class="row mt-4 no-print">
            <div class="col-12 text-center">
                ...
                <a href="invoices.php?type=repair" class="btn btn-secondary">Back to Invoices</a>
            </div>
        </div>
    </div>
